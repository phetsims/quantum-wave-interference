...
/**
 * Factory function that creates the wave visualization region, double slit node, and derived slit
...
type CreateWaveRegionNodesOptions = {
...
const createWaveRegionNodes = (
  model: WaveRegionModel,
  options: CreateWaveRegionNodesOptions
): WaveRegionNodes => {
  ...
  return { waveVisualizationNode: waveVisualizationNode, doubleSlitNode: doubleSlitNode };
};

export default createWaveRegionNodes;
