...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    experimentDetectorScreenDetails: {
      ...
      leadingParagraph: new FluentPattern<{ detectionMode: 'averageIntensity' | 'hits' | TReadOnlyProperty<'averageIntensity' | 'hits'>, detectorScreenIsEmpty: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, sourceType: 'photons' | 'electrons' | 'neutrons' | 'heliumAtoms' | TReadOnlyProperty<'photons' | 'electrons' | 'neutrons' | 'heliumAtoms'> }>( fluentSupport.bundleProperty, 'a11y_experimentDetectorScreenDetails_leadingParagraph', _.get( QuantumWaveInterferenceStrings, 'a11y.experimentDetectorScreenDetails.leadingParagraphStringProperty' ), [{"name":"detectionMode","variants":["averageIntensity","hits"]},{"name":"detectorScreenIsEmpty","variants":["true","false"]},{"name":"sourceType","variants":["photons","electrons","neutrons","heliumAtoms"]}] ),
