...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    highIntensityState: {
      ...
      waveProgress: new FluentPattern<{ progress: FluentVariable, slitSetting: 'leftDetector' | 'rightDetector' | 'bothDetectors' | TReadOnlyProperty<'leftDetector' | 'rightDetector' | 'bothDetectors'>, waveProgressCheckpoint: 'quarter' | 'half' | 'threeQuarters' | 'full' | 'none' | TReadOnlyProperty<'quarter' | 'half' | 'threeQuarters' | 'full' | 'none'>, waveProgressStage: 'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen' | TReadOnlyProperty<'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityState_waveProgress', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.waveProgressStringProperty' ), [{"name":"progress"},{"name":"slitSetting","variants":["leftDetector","rightDetector","bothDetectors"]},{"name":"waveProgressCheckpoint","variants":["quarter","half","threeQuarters","full","none"]},{"name":"waveProgressStage","variants":["sourceOff","travelingToSlits","atSlits","interferingAfterSlits","diffractingAfterSlits","whichPathAfterSlits","directToScreen","hittingScreen"]}] ),
    ...
    highIntensityResponses: {
      ...
      screenCleared: new FluentPattern<{ isRestarting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, sourceStartedResponse: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_screenCleared', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.screenClearedStringProperty' ), [{"name":"isRestarting","variants":["true","false"]},{"name":"sourceStartedResponse"}] ),
      ...
      waveProgressChanged: new FluentPattern<{ progress: FluentVariable, slitSetting: 'leftDetector' | 'rightDetector' | 'bothDetectors' | TReadOnlyProperty<'leftDetector' | 'rightDetector' | 'bothDetectors'>, waveProgressCheckpoint: 'quarter' | 'half' | 'threeQuarters' | 'full' | 'none' | TReadOnlyProperty<'quarter' | 'half' | 'threeQuarters' | 'full' | 'none'>, waveProgressStage: 'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen' | TReadOnlyProperty<'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_waveProgressChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.waveProgressChangedStringProperty' ), [{"name":"progress"},{"name":"slitSetting","variants":["leftDetector","rightDetector","bothDetectors"]},{"name":"waveProgressCheckpoint","variants":["quarter","half","threeQuarters","full","none"]},{"name":"waveProgressStage","variants":["sourceOff","travelingToSlits","atSlits","interferingAfterSlits","diffractingAfterSlits","whichPathAfterSlits","directToScreen","hittingScreen"]}] ),
