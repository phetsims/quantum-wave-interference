...
addToMapIfDefined( 'a11y_waveExperimentResponses_waveProgressTarget', 'a11y.waveExperimentResponses.waveProgressTargetStringProperty' );
...
addToMapIfDefined( 'a11y_detectorPatternGraph_accessibleParagraph_hitsSteadyStatePattern', 'a11y.detectorPatternGraph.accessibleParagraph.hitsSteadyStatePatternStringProperty' );
...
addToMapIfDefined( 'a11y_detectorPatternGraph_accessibleParagraph_hitsNoBarrierEmerging', 'a11y.detectorPatternGraph.accessibleParagraph.hitsNoBarrierEmergingStringProperty' );
addToMapIfDefined( 'a11y_detectorPatternGraph_accessibleParagraph_hitsNoBarrierDeveloping', 'a11y.detectorPatternGraph.accessibleParagraph.hitsNoBarrierDevelopingStringProperty' );
addToMapIfDefined( 'a11y_detectorPatternGraph_accessibleParagraph_hitsNoBarrierSteadyStatePattern', 'a11y.detectorPatternGraph.accessibleParagraph.hitsNoBarrierSteadyStatePatternStringProperty' );
...
addToMapIfDefined( 'a11y_detectorScreen_snapshotHitsParagraph', 'a11y.detectorScreen.snapshotHitsParagraphStringProperty' );
...
addToMapIfDefined( 'a11y_detectorScreen_accessibleParagraph_hitsSteadyStatePattern', 'a11y.detectorScreen.accessibleParagraph.hitsSteadyStatePatternStringProperty' );
...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    waveExperimentResponses: {
      ...
      _comment_0: new FluentComment( {"comment":"Names whichever detection surface is currently displayed — the detector screen, the intensity graph, or the","associatedKey":"screenEmpty"} ),
      _comment_1: new FluentComment( {"comment":"hits histogram when the graph view replaces the screen — so the prompt never describes a hidden surface.","associatedKey":"screenEmpty"} ),
      screenEmpty: new FluentPattern<{ surface: 'graph' | 'histogram' | 'detectorScreen' | TReadOnlyProperty<'graph' | 'histogram' | 'detectorScreen'> }>( fluentSupport.bundleProperty, 'a11y_waveExperimentResponses_screenEmpty', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentResponses.screenEmptyStringProperty' ), [{"name":"surface","variants":["graph","histogram","detectorScreen"]}] ),
      ...
      waveDisplayChanged: new FluentPattern<{ waveDisplayMode: 'electricField' | 'realPart' | 'amplitude' | TReadOnlyProperty<'electricField' | 'realPart' | 'amplitude'> }>( fluentSupport.bundleProperty, 'a11y_waveExperimentResponses_waveDisplayChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentResponses.waveDisplayChangedStringProperty' ), [{"name":"waveDisplayMode","variants":["electricField","realPart","amplitude"]}] ),
      ...
      _comment_2: new FluentComment( {"comment":"Destination named by the wave-progress responses below: the detector screen, or the graph when the graph view","associatedKey":"waveProgressTarget"} ),
      _comment_3: new FluentComment( {"comment":"replaces the screen. Includes the sentence-ending period, mirroring a11y.sourceWaveFragments.slitTarget.","associatedKey":"waveProgressTarget"} ),
      waveProgressTarget: new FluentPattern<{ surface: 'graph' | 'detectorScreen' | TReadOnlyProperty<'graph' | 'detectorScreen'> }>( fluentSupport.bundleProperty, 'a11y_waveExperimentResponses_waveProgressTarget', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentResponses.waveProgressTargetStringProperty' ), [{"name":"surface","variants":["graph","detectorScreen"]}] ),
      waveProgressChanged: new FluentPattern<{ patternKind: 'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier' | TReadOnlyProperty<'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier'>, surface: 'graph' | 'detectorScreen' | TReadOnlyProperty<'graph' | 'detectorScreen'>, waveDisplayMode: 'amplitude' | 'electricField' | 'realPart' | TReadOnlyProperty<'amplitude' | 'electricField' | 'realPart'>, waveProgressStage: 'sourceOff' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | TReadOnlyProperty<'sourceOff' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen'> }>( fluentSupport.bundleProperty, 'a11y_waveExperimentResponses_waveProgressChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentResponses.waveProgressChangedStringProperty' ), [{"name":"patternKind","variants":["doubleSlitInterference","singleSlitDiffraction","whichPathDiffraction","noBarrier"]},{"name":"surface","variants":["graph","detectorScreen"]},{"name":"waveDisplayMode","variants":["amplitude","electricField","realPart"]},{"name":"waveProgressStage","variants":["sourceOff","atSlits","interferingAfterSlits","diffractingAfterSlits","whichPathAfterSlits","directToScreen"]}] ),
    ...
    timePlot: {
      ...
      accessibleParagraph: new FluentPattern<{ waveDisplayMode: 'electricField' | 'realPart' | 'amplitude' | TReadOnlyProperty<'electricField' | 'realPart' | 'amplitude'> }>( fluentSupport.bundleProperty, 'a11y_timePlot_accessibleParagraph', _.get( QuantumWaveInterferenceStrings, 'a11y.timePlot.accessibleParagraphStringProperty' ), [{"name":"waveDisplayMode","variants":["electricField","realPart","amplitude"]}] )
    },
    positionPlot: {
      ...
      accessibleParagraph: new FluentPattern<{ waveDisplayMode: 'electricField' | 'realPart' | 'amplitude' | TReadOnlyProperty<'electricField' | 'realPart' | 'amplitude'> }>( fluentSupport.bundleProperty, 'a11y_positionPlot_accessibleParagraph', _.get( QuantumWaveInterferenceStrings, 'a11y.positionPlot.accessibleParagraphStringProperty' ), [{"name":"waveDisplayMode","variants":["electricField","realPart","amplitude"]}] )
    },
    detectorProbe: {
    ...
    detectorPatternGraph: {
      accessibleParagraph: {
        ...
        hitsSteadyStatePattern: new FluentPattern<{ envelope: 'clusteringIntoTwoFaintSections' | 'clusteringIntoTwoDistinctSections' | 'brightestAtCenter' | TReadOnlyProperty<'clusteringIntoTwoFaintSections' | 'clusteringIntoTwoDistinctSections' | 'brightestAtCenter'>, spatialDescription: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_hitsSteadyStatePattern', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.hitsSteadyStatePatternStringProperty' ), [{"name":"envelope","variants":["clusteringIntoTwoFaintSections","clusteringIntoTwoDistinctSections","brightestAtCenter"]},{"name":"spatialDescription"}] ),
        ...
        hitsNoBarrierEmergingStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_hitsNoBarrierEmerging', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.hitsNoBarrierEmergingStringProperty' ) ),
        hitsNoBarrierDevelopingStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_hitsNoBarrierDeveloping', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.hitsNoBarrierDevelopingStringProperty' ) ),
        hitsNoBarrierSteadyStatePatternStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_hitsNoBarrierSteadyStatePattern', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.hitsNoBarrierSteadyStatePatternStringProperty' ) )
      },
      zoomButtonGroup: {
    ...
    detectorScreen: {
      ...
      _comment_0: new FluentComment( {"comment":"Composes a snapshot hits paragraph: the same description used for the live detector screen, followed by the","associatedKey":"snapshotHitsParagraph"} ),
      _comment_1: new FluentComment( {"comment":"running total of hits captured in the snapshot.","associatedKey":"snapshotHitsParagraph"} ),
      snapshotHitsParagraph: new FluentPattern<{ description: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_snapshotHitsParagraph', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.snapshotHitsParagraphStringProperty' ), [{"name":"description"}] ),
      accessibleParagraph: {
        ...
        hitsSteadyStatePattern: new FluentPattern<{ spacingDescription: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_hitsSteadyStatePattern', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.hitsSteadyStatePatternStringProperty' ), [{"name":"spacingDescription"}] )
      },
      spatialDescription: {
        rulerDoubleSlit: new FluentPattern<{ count: FluentVariable, spacing: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_spatialDescription_rulerDoubleSlit', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.spatialDescription.rulerDoubleSlitStringProperty' ), [{"name":"count"},{"name":"spacing"}] ),
        noRulerDoubleSlit: new FluentPattern<{ count: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_spatialDescription_noRulerDoubleSlit', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.spatialDescription.noRulerDoubleSlitStringProperty' ), [{"name":"count"}] ),
        rulerSingleSlit: new FluentPattern<{ centralWidth: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_spatialDescription_rulerSingleSlit', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.spatialDescription.rulerSingleSlitStringProperty' ), [{"name":"centralWidth"}] ),
        noRulerSingleSlitStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_detectorScreen_spatialDescription_noRulerSingleSlit', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.spatialDescription.noRulerSingleSlitStringProperty' ) )
      },
      zoomButtonGroup: {
