  ...
  a11y: {
    ...
    detectorScreen: {
      ...
      accessibleParagraph: {
        ...
        hitsSingleSlitClear: new FluentPattern<{ envelope: 'clusteringIntoTwoFaintSections' | 'clusteringIntoTwoDistinctSections' | 'brightestAtCenter' | TReadOnlyProperty<'clusteringIntoTwoFaintSections' | 'clusteringIntoTwoDistinctSections' | 'brightestAtCenter'> }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_hitsSingleSlitClear', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.hitsSingleSlitClearStringProperty' ), [{"name":"envelope","variants":["clusteringIntoTwoFaintSections","clusteringIntoTwoDistinctSections","brightestAtCenter"]}] ),
