...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    highIntensityState: {
      ...
      sourceBeam: new FluentPattern<{ isEmitting: 'false' | 'true' | TReadOnlyProperty<'false' | 'true'>, photonColor: 'violet' | 'blue' | 'indigo' | 'green' | 'yellow' | 'orange' | 'red' | TReadOnlyProperty<'violet' | 'blue' | 'indigo' | 'green' | 'yellow' | 'orange' | 'red'>, sourceType: 'photons' | 'electrons' | 'neutrons' | 'heliumAtoms' | TReadOnlyProperty<'photons' | 'electrons' | 'neutrons' | 'heliumAtoms'>, wavefrontSpacing: 'tightlyPacked' | 'widelySpaced' | 'moderatelySpaced' | TReadOnlyProperty<'tightlyPacked' | 'widelySpaced' | 'moderatelySpaced'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityState_sourceBeam', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.sourceBeamStringProperty' ), [{"name":"isEmitting","variants":["false","true"]},{"name":"photonColor","variants":["violet","blue","indigo","green","yellow","orange","red"]},{"name":"sourceType","variants":["photons","electrons","neutrons","heliumAtoms"]},{"name":"wavefrontSpacing","variants":["tightlyPacked","widelySpaced","moderatelySpaced"]}] ),
      ...
      detectorPattern: new FluentPattern<{ bandCount: FluentVariable, detectionMode: 'averageIntensity' | 'hits' | TReadOnlyProperty<'averageIntensity' | 'hits'>, hitCount: FluentVariable, hitStage: 'none' | number | 'few' | 'emerging' | 'developing' | 'clear' | TReadOnlyProperty<'none' | number | 'few' | 'emerging' | 'developing' | 'clear'>, isEmitting: 'false' | 'true' | TReadOnlyProperty<'false' | 'true'>, patternFormation: 'empty' | 'forming' | 'complete' | 'paused' | 'notApplicable' | 'collectingHits' | TReadOnlyProperty<'empty' | 'forming' | 'complete' | 'paused' | 'notApplicable' | 'collectingHits'>, patternKind: 'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier' | TReadOnlyProperty<'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityState_detectorPattern', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.detectorPatternStringProperty' ), [{"name":"bandCount"},{"name":"detectionMode","variants":["averageIntensity","hits"]},{"name":"hitCount"},{"name":"hitStage","variants":["none",{"type":"number","value":"few"},"emerging","developing","clear"]},{"name":"isEmitting","variants":["false","true"]},{"name":"patternFormation","variants":["empty","forming","complete","paused","notApplicable","collectingHits"]},{"name":"patternKind","variants":["doubleSlitInterference","singleSlitDiffraction","whichPathDiffraction","noBarrier"]}] ),
    ...
    highIntensityResponses: {
      sourceStarted: new FluentPattern<{ beamDescription: FluentVariable, isPlaying: 'false' | 'true' | TReadOnlyProperty<'false' | 'true'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_sourceStarted', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.sourceStartedStringProperty' ), [{"name":"beamDescription"},{"name":"isPlaying","variants":["false","true"]}] ),
      ...
      slitSeparationChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_slitSeparationChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.slitSeparationChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]}] ),
      wavelengthChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_wavelengthChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.wavelengthChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]}] ),
      speedChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_speedChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.speedChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]}] ),
