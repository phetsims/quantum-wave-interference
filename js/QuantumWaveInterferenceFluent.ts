  ...
  a11y: {
    ...
    graphAccordionBox: {
      accessibleParagraph: {
        ...
        hitsFew: new FluentPattern<{ totalHits: 1 | number | 'other' | TReadOnlyProperty<1 | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_graphAccordionBox_accessibleParagraph_hitsFew', _.get( QuantumWaveInterferenceStrings, 'a11y.graphAccordionBox.accessibleParagraph.hitsFewStringProperty' ), [{"name":"totalHits","variants":[1,{"type":"number","value":"other"}]}] ),
        hitsEmerging: new FluentPattern<{ totalHits: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_graphAccordionBox_accessibleParagraph_hitsEmerging', _.get( QuantumWaveInterferenceStrings, 'a11y.graphAccordionBox.accessibleParagraph.hitsEmergingStringProperty' ), [{"name":"totalHits"}] ),
        hitsDeveloping: new FluentPattern<{ spatialDescription: FluentVariable, totalHits: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_graphAccordionBox_accessibleParagraph_hitsDeveloping', _.get( QuantumWaveInterferenceStrings, 'a11y.graphAccordionBox.accessibleParagraph.hitsDevelopingStringProperty' ), [{"name":"spatialDescription"},{"name":"totalHits"}] ),
        hitsClear: new FluentPattern<{ spatialDescription: FluentVariable, totalHits: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_graphAccordionBox_accessibleParagraph_hitsClear', _.get( QuantumWaveInterferenceStrings, 'a11y.graphAccordionBox.accessibleParagraph.hitsClearStringProperty' ), [{"name":"spatialDescription"},{"name":"totalHits"}] ),
        hitsSingleSlitEmerging: new FluentPattern<{ totalHits: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_graphAccordionBox_accessibleParagraph_hitsSingleSlitEmerging', _.get( QuantumWaveInterferenceStrings, 'a11y.graphAccordionBox.accessibleParagraph.hitsSingleSlitEmergingStringProperty' ), [{"name":"totalHits"}] ),
        hitsSingleSlitClear: new FluentPattern<{ spatialDescription: FluentVariable, totalHits: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_graphAccordionBox_accessibleParagraph_hitsSingleSlitClear', _.get( QuantumWaveInterferenceStrings, 'a11y.graphAccordionBox.accessibleParagraph.hitsSingleSlitClearStringProperty' ), [{"name":"spatialDescription"},{"name":"totalHits"}] )
      },
    ...
    detectorScreen: {
      accessibleParagraph: {
        ...
        hitsEmerging: new FluentPattern<{ spatialDescription: FluentVariable, totalHits: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_hitsEmerging', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.hitsEmergingStringProperty' ), [{"name":"spatialDescription"},{"name":"totalHits"}] ),
        hitsDeveloping: new FluentPattern<{ spatialDescription: FluentVariable, totalHits: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_hitsDeveloping', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.hitsDevelopingStringProperty' ), [{"name":"spatialDescription"},{"name":"totalHits"}] ),
        hitsClear: new FluentPattern<{ spatialDescription: FluentVariable, totalHits: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_hitsClear', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.hitsClearStringProperty' ), [{"name":"spatialDescription"},{"name":"totalHits"}] ),
        hitsSingleSlitEmerging: new FluentPattern<{ spatialDescription: FluentVariable, totalHits: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_hitsSingleSlitEmerging', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.hitsSingleSlitEmergingStringProperty' ), [{"name":"spatialDescription"},{"name":"totalHits"}] ),
