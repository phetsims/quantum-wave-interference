...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    experimentDetectorScreenDetails: {
      ...
      leadingParagraph: new FluentPattern<{ detectionMode: 'averageIntensity' | 'hits' | TReadOnlyProperty<'averageIntensity' | 'hits'>, detectorScreenStatus: 'empty' | 'emptyWavePropagating' | 'pattern' | TReadOnlyProperty<'empty' | 'emptyWavePropagating' | 'pattern'>, sourceType: 'photons' | 'electrons' | 'neutrons' | 'heliumAtoms' | TReadOnlyProperty<'photons' | 'electrons' | 'neutrons' | 'heliumAtoms'> }>( fluentSupport.bundleProperty, 'a11y_experimentDetectorScreenDetails_leadingParagraph', _.get( QuantumWaveInterferenceStrings, 'a11y.experimentDetectorScreenDetails.leadingParagraphStringProperty' ), [{"name":"detectionMode","variants":["averageIntensity","hits"]},{"name":"detectorScreenStatus","variants":["empty","emptyWavePropagating","pattern"]},{"name":"sourceType","variants":["photons","electrons","neutrons","heliumAtoms"]}] ),
