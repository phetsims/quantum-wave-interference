...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    highIntensityResponses: {
      ...
      sourceStopped: new FluentPattern<{ hasHitsData: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_sourceStopped', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.sourceStoppedStringProperty' ), [{"name":"hasHitsData","variants":["true","false"]}] ),
      ...
      detectionModeChanged: new FluentPattern<{ detectionMode: 'intensity' | 'hits' | TReadOnlyProperty<'intensity' | 'hits'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_detectionModeChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.detectionModeChangedStringProperty' ), [{"name":"detectionMode","variants":["intensity","hits"]}] ),
      ...
      toolChanged: new FluentPattern<{ isVisible: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, tool: 'measuringTape' | 'stopwatch' | 'timePlot' | 'positionPlot' | TReadOnlyProperty<'measuringTape' | 'stopwatch' | 'timePlot' | 'positionPlot'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_toolChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.toolChangedStringProperty' ), [{"name":"isVisible","variants":["true","false"]},{"name":"tool","variants":["measuringTape","stopwatch","timePlot","positionPlot"]}] ),
