...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    highIntensityResponses: {
      ...
      sourceRestarted: new FluentPattern<{ beamDescription: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_sourceRestarted', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.sourceRestartedStringProperty' ), [{"name":"beamDescription"}] ),
      ...
      particleTypeChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, sourceRestartedResponse: FluentVariable, sourceType: 'photons' | 'electrons' | 'neutrons' | 'heliumAtoms' | TReadOnlyProperty<'photons' | 'electrons' | 'neutrons' | 'heliumAtoms'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_particleTypeChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.particleTypeChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]},{"name":"sourceRestartedResponse"},{"name":"sourceType","variants":["photons","electrons","neutrons","heliumAtoms"]}] ),
