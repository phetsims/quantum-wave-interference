...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    detectorScreenPositionSlider: {
      ...
      accessibleContextResponseHits: new FluentPattern<{ position: 'closest' | 'closer' | 'farthest' | 'farther' | TReadOnlyProperty<'closest' | 'closer' | 'farthest' | 'farther'> }>( fluentSupport.bundleProperty, 'a11y_detectorScreenPositionSlider_accessibleContextResponseHits', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreenPositionSlider.accessibleContextResponseHitsStringProperty' ), [{"name":"position","variants":["closest","closer","farthest","farther"]}] ),
