...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    _comment_3: new FluentComment( {"comment":"Shared fragments composed into the source beam/packet descriptions on the High Intensity and Single Particles","associatedKey":"sourceWaveFragments"} ),
    _comment_4: new FluentComment( {"comment":"screens. Each fragment resolves its { $variable } placeholders from the referencing message's format() arguments.","associatedKey":"sourceWaveFragments"} ),
    sourceWaveFragments: {
