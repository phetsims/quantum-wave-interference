...
addToMapIfDefined( 'a11y_waveExperimentState_overview', 'a11y.waveExperimentState.overviewStringProperty' );
addToMapIfDefined( 'a11y_waveExperimentState_sourceStatus', 'a11y.waveExperimentState.sourceStatusStringProperty' );
...
addToMapIfDefined( 'a11y_waveExperimentState_waveProgress', 'a11y.waveExperimentState.waveProgressStringProperty' );
addToMapIfDefined( 'a11y_waveExperimentState_displayTools', 'a11y.waveExperimentState.displayToolsStringProperty' );
...
addToMapIfDefined( 'a11y_waveExperimentResponses_hitStageChanged', 'a11y.waveExperimentResponses.hitStageChangedStringProperty' );
...
addToMapIfDefined( 'a11y_detectorPatternGraph_zoomButtonGroup_zoomInAccessibleHelpText', 'a11y.detectorPatternGraph.zoomButtonGroup.zoomInAccessibleHelpTextStringProperty' );
addToMapIfDefined( 'a11y_detectorPatternGraph_zoomButtonGroup_zoomOutAccessibleHelpText', 'a11y.detectorPatternGraph.zoomButtonGroup.zoomOutAccessibleHelpTextStringProperty' );
...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    _comment_1: new FluentComment( {"comment":"screens. Each fragment resolves its { $variable } placeholders from the referencing message's format() arguments.","associatedKey":"sourceWaveFragments"} ),
    sourceWaveFragments: {
    ...
    waveExperimentState: {
      overview: new FluentPattern<{ detectionMode: 'intensity' | 'hits' | TReadOnlyProperty<'intensity' | 'hits'>, displayMode: 'graph' | 'screen' | TReadOnlyProperty<'graph' | 'screen'>, isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, isPlaying: 'false' | 'true' | TReadOnlyProperty<'false' | 'true'>, sourceType: 'photons' | 'electrons' | 'neutrons' | 'heliumAtoms' | TReadOnlyProperty<'photons' | 'electrons' | 'neutrons' | 'heliumAtoms'> }>( fluentSupport.bundleProperty, 'a11y_waveExperimentState_overview', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentState.overviewStringProperty' ), [{"name":"detectionMode","variants":["intensity","hits"]},{"name":"displayMode","variants":["graph","screen"]},{"name":"isEmitting","variants":["true","false"]},{"name":"isPlaying","variants":["false","true"]},{"name":"sourceType","variants":["photons","electrons","neutrons","heliumAtoms"]}] ),
      sourceStatus: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, isPlaying: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, timeSpeed: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_waveExperimentState_sourceStatus', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentState.sourceStatusStringProperty' ), [{"name":"isEmitting","variants":["true","false"]},{"name":"isPlaying","variants":["true","false"]},{"name":"timeSpeed"}] ),
      ...
      detectorPattern: new FluentPattern<{ bandSpacing: 'extremelyFarApart' | 'veryFarApart' | 'farApart' | 'somewhatCloseTogether' | 'closeTogether' | 'veryCloseTogether' | 'extremelyCloseTogether' | TReadOnlyProperty<'extremelyFarApart' | 'veryFarApart' | 'farApart' | 'somewhatCloseTogether' | 'closeTogether' | 'veryCloseTogether' | 'extremelyCloseTogether'>, detectionMode: 'intensity' | 'hits' | TReadOnlyProperty<'intensity' | 'hits'>, hitCount: FluentVariable, hitStage: 'none' | number | 'few' | 'emerging' | 'developing' | 'clear' | TReadOnlyProperty<'none' | number | 'few' | 'emerging' | 'developing' | 'clear'>, isEmitting: 'false' | 'true' | TReadOnlyProperty<'false' | 'true'>, patternFormation: 'empty' | 'forming' | 'complete' | 'paused' | 'notApplicable' | 'collectingHits' | TReadOnlyProperty<'empty' | 'forming' | 'complete' | 'paused' | 'notApplicable' | 'collectingHits'>, patternKind: 'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier' | TReadOnlyProperty<'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier'>, slitSetting: 'leftCovered' | 'rightCovered' | TReadOnlyProperty<'leftCovered' | 'rightCovered'>, waveDisplayMode: 'amplitude' | 'electricField' | 'realPart' | 'imaginaryPart' | TReadOnlyProperty<'amplitude' | 'electricField' | 'realPart' | 'imaginaryPart'> }>( fluentSupport.bundleProperty, 'a11y_waveExperimentState_detectorPattern', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentState.detectorPatternStringProperty' ), [{"name":"bandSpacing","variants":["extremelyFarApart","veryFarApart","farApart","somewhatCloseTogether","closeTogether","veryCloseTogether","extremelyCloseTogether"]},{"name":"detectionMode","variants":["intensity","hits"]},{"name":"hitCount"},{"name":"hitStage","variants":["none",{"type":"number","value":"few"},"emerging","developing","clear"]},{"name":"isEmitting","variants":["false","true"]},{"name":"patternFormation","variants":["empty","forming","complete","paused","notApplicable","collectingHits"]},{"name":"patternKind","variants":["doubleSlitInterference","singleSlitDiffraction","whichPathDiffraction","noBarrier"]},{"name":"slitSetting","variants":["leftCovered","rightCovered"]},{"name":"waveDisplayMode","variants":["amplitude","electricField","realPart","imaginaryPart"]}] ),
      waveProgress: new FluentPattern<{ patternKind: 'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier' | TReadOnlyProperty<'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier'>, waveDisplayMode: 'amplitude' | 'electricField' | 'realPart' | 'imaginaryPart' | TReadOnlyProperty<'amplitude' | 'electricField' | 'realPart' | 'imaginaryPart'>, waveProgressStage: 'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen' | TReadOnlyProperty<'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen'> }>( fluentSupport.bundleProperty, 'a11y_waveExperimentState_waveProgress', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentState.waveProgressStringProperty' ), [{"name":"patternKind","variants":["doubleSlitInterference","singleSlitDiffraction","whichPathDiffraction","noBarrier"]},{"name":"waveDisplayMode","variants":["amplitude","electricField","realPart","imaginaryPart"]},{"name":"waveProgressStage","variants":["sourceOff","travelingToSlits","atSlits","interferingAfterSlits","diffractingAfterSlits","whichPathAfterSlits","directToScreen","hittingScreen"]}] ),
      displayTools: new FluentPattern<{ brightness: FluentVariable, displayMode: 'graph' | 'screen' | TReadOnlyProperty<'graph' | 'screen'>, measuringTape: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, positionPlot: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, snapshotCount: FluentVariable, stopwatch: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, timePlot: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, waveDisplayMode: 'electricField' | 'realPart' | 'imaginaryPart' | 'amplitude' | TReadOnlyProperty<'electricField' | 'realPart' | 'imaginaryPart' | 'amplitude'> }>( fluentSupport.bundleProperty, 'a11y_waveExperimentState_displayTools', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentState.displayToolsStringProperty' ), [{"name":"brightness"},{"name":"displayMode","variants":["graph","screen"]},{"name":"measuringTape","variants":["true","false"]},{"name":"positionPlot","variants":["true","false"]},{"name":"snapshotCount"},{"name":"stopwatch","variants":["true","false"]},{"name":"timePlot","variants":["true","false"]},{"name":"waveDisplayMode","variants":["electricField","realPart","imaginaryPart","amplitude"]}] )
    },
    waveExperimentResponses: {
      ...
      slitConfigurationChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, slitSetting: 'bothOpen' | 'leftCovered' | 'rightCovered' | 'leftDetector' | 'rightDetector' | 'noBarrier' | 'bothDetectors' | TReadOnlyProperty<'bothOpen' | 'leftCovered' | 'rightCovered' | 'leftDetector' | 'rightDetector' | 'noBarrier' | 'bothDetectors'>, sourceRestartedResponse: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_waveExperimentResponses_slitConfigurationChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentResponses.slitConfigurationChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]},{"name":"slitSetting","variants":["bothOpen","leftCovered","rightCovered","leftDetector","rightDetector","noBarrier","bothDetectors"]},{"name":"sourceRestartedResponse"}] ),
      slitSeparationChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, sourceRestartedResponse: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_waveExperimentResponses_slitSeparationChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentResponses.slitSeparationChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]},{"name":"sourceRestartedResponse"}] ),
      wavelengthChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, sourceRestartedResponse: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_waveExperimentResponses_wavelengthChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentResponses.wavelengthChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]},{"name":"sourceRestartedResponse"}] ),
      speedChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, sourceRestartedResponse: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_waveExperimentResponses_speedChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentResponses.speedChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]},{"name":"sourceRestartedResponse"}] ),
      displayModeChanged: new FluentPattern<{ displayMode: 'graph' | 'screen' | TReadOnlyProperty<'graph' | 'screen'> }>( fluentSupport.bundleProperty, 'a11y_waveExperimentResponses_displayModeChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.waveExperimentResponses.displayModeChangedStringProperty' ), [{"name":"displayMode","variants":["graph","screen"]}] ),
    ...
    experimentSetupDetails: {
      ...
      detectionMode: new FluentPattern<{ detectionMode: 'intensity' | 'hits' | TReadOnlyProperty<'intensity' | 'hits'> }>( fluentSupport.bundleProperty, 'a11y_experimentSetupDetails_detectionMode', _.get( QuantumWaveInterferenceStrings, 'a11y.experimentSetupDetails.detectionModeStringProperty' ), [{"name":"detectionMode","variants":["intensity","hits"]}] ),
    ...
    graphAccordionBox: {
      ...
      accessibleContextResponseExpanded: new FluentPattern<{ detectionMode: 'intensity' | 'hits' | TReadOnlyProperty<'intensity' | 'hits'> }>( fluentSupport.bundleProperty, 'a11y_graphAccordionBox_accessibleContextResponseExpanded', _.get( QuantumWaveInterferenceStrings, 'a11y.graphAccordionBox.accessibleContextResponseExpandedStringProperty' ), [{"name":"detectionMode","variants":["intensity","hits"]}] ),
    ...
    detectorPatternGraph: {
      accessibleParagraph: {
        ...
        intensity: new FluentPattern<{ spatialDescription: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_intensity', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.intensityStringProperty' ), [{"name":"spatialDescription"}] ),
        intensitySingleSlitStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_intensitySingleSlit', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.intensitySingleSlitStringProperty' ) ),
        ...
        hitsEmergingStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_hitsEmerging', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.hitsEmergingStringProperty' ) ),
        hitsDeveloping: new FluentPattern<{ spatialDescription: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_hitsDeveloping', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.hitsDevelopingStringProperty' ), [{"name":"spatialDescription"}] ),
        hitsClear: new FluentPattern<{ spatialDescription: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_hitsClear', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.hitsClearStringProperty' ), [{"name":"spatialDescription"}] ),
        ...
        hitsSingleSlitClear: new FluentPattern<{ spatialDescription: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_accessibleParagraph_hitsSingleSlitClear', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.accessibleParagraph.hitsSingleSlitClearStringProperty' ), [{"name":"spatialDescription"}] )
      },
      zoomButtonGroup: {
        zoomInAccessibleHelpTextStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_zoomButtonGroup_zoomInAccessibleHelpText', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.zoomButtonGroup.zoomInAccessibleHelpTextStringProperty' ) ),
        zoomOutAccessibleHelpTextStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_detectorPatternGraph_zoomButtonGroup_zoomOutAccessibleHelpText', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorPatternGraph.zoomButtonGroup.zoomOutAccessibleHelpTextStringProperty' ) )
      }
    },
    zoomButtonGroup: {
