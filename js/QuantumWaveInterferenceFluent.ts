...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    highIntensityState: {
      ...
      detectorPattern: new FluentPattern<{ bandCount: FluentVariable, bandSpacing: 'farApart' | 'closelySpaced' | 'mediumSpaced' | TReadOnlyProperty<'farApart' | 'closelySpaced' | 'mediumSpaced'>, detectionMode: 'averageIntensity' | 'hits' | TReadOnlyProperty<'averageIntensity' | 'hits'>, hitCount: FluentVariable, hitStage: 'none' | number | 'few' | 'emerging' | 'developing' | 'clear' | TReadOnlyProperty<'none' | number | 'few' | 'emerging' | 'developing' | 'clear'>, isEmitting: 'false' | 'true' | TReadOnlyProperty<'false' | 'true'>, patternFormation: 'empty' | 'forming' | 'complete' | 'paused' | 'notApplicable' | 'collectingHits' | TReadOnlyProperty<'empty' | 'forming' | 'complete' | 'paused' | 'notApplicable' | 'collectingHits'>, patternKind: 'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier' | TReadOnlyProperty<'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityState_detectorPattern', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.detectorPatternStringProperty' ), [{"name":"bandCount"},{"name":"bandSpacing","variants":["farApart","closelySpaced","mediumSpaced"]},{"name":"detectionMode","variants":["averageIntensity","hits"]},{"name":"hitCount"},{"name":"hitStage","variants":["none",{"type":"number","value":"few"},"emerging","developing","clear"]},{"name":"isEmitting","variants":["false","true"]},{"name":"patternFormation","variants":["empty","forming","complete","paused","notApplicable","collectingHits"]},{"name":"patternKind","variants":["doubleSlitInterference","singleSlitDiffraction","whichPathDiffraction","noBarrier"]}] ),
      waveProgress: new FluentPattern<{ progress: FluentVariable, slitSetting: 'leftDetector' | 'rightDetector' | 'bothDetectors' | TReadOnlyProperty<'leftDetector' | 'rightDetector' | 'bothDetectors'>, waveProgressCheckpoint: 'quarter' | 'half' | 'threeQuarters' | 'full' | 'none' | TReadOnlyProperty<'quarter' | 'half' | 'threeQuarters' | 'full' | 'none'>, waveProgressStage: 'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen' | TReadOnlyProperty<'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen'>, waveSpeed: 'slow' | 'fast' | 'medium' | TReadOnlyProperty<'slow' | 'fast' | 'medium'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityState_waveProgress', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.waveProgressStringProperty' ), [{"name":"progress"},{"name":"slitSetting","variants":["leftDetector","rightDetector","bothDetectors"]},{"name":"waveProgressCheckpoint","variants":["quarter","half","threeQuarters","full","none"]},{"name":"waveProgressStage","variants":["sourceOff","travelingToSlits","atSlits","interferingAfterSlits","diffractingAfterSlits","whichPathAfterSlits","directToScreen","hittingScreen"]},{"name":"waveSpeed","variants":["slow","fast","medium"]}] ),
    ...
    highIntensityResponses: {
      ...
      wavelengthChanged: new FluentPattern<{ beamDescription: FluentVariable, isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_wavelengthChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.wavelengthChangedStringProperty' ), [{"name":"beamDescription"},{"name":"isEmitting","variants":["true","false"]}] ),
      ...
      waveProgressChanged: new FluentPattern<{ progress: FluentVariable, slitSetting: 'leftDetector' | 'rightDetector' | 'bothDetectors' | TReadOnlyProperty<'leftDetector' | 'rightDetector' | 'bothDetectors'>, waveProgressCheckpoint: 'quarter' | 'half' | 'threeQuarters' | 'full' | 'none' | TReadOnlyProperty<'quarter' | 'half' | 'threeQuarters' | 'full' | 'none'>, waveProgressStage: 'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen' | TReadOnlyProperty<'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen'>, waveSpeed: 'slow' | 'fast' | 'medium' | TReadOnlyProperty<'slow' | 'fast' | 'medium'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_waveProgressChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.waveProgressChangedStringProperty' ), [{"name":"progress"},{"name":"slitSetting","variants":["leftDetector","rightDetector","bothDetectors"]},{"name":"waveProgressCheckpoint","variants":["quarter","half","threeQuarters","full","none"]},{"name":"waveProgressStage","variants":["sourceOff","travelingToSlits","atSlits","interferingAfterSlits","diffractingAfterSlits","whichPathAfterSlits","directToScreen","hittingScreen"]},{"name":"waveSpeed","variants":["slow","fast","medium"]}] ),
