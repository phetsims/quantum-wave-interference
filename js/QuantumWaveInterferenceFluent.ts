...
addToMapIfDefined( 'a11y_highIntensityState_heading', 'a11y.highIntensityState.headingStringProperty' );
addToMapIfDefined( 'a11y_highIntensityState_sourceLabel', 'a11y.highIntensityState.sourceLabelStringProperty' );
addToMapIfDefined( 'a11y_highIntensityState_slitsLabel', 'a11y.highIntensityState.slitsLabelStringProperty' );
addToMapIfDefined( 'a11y_highIntensityState_detectorPatternLabel', 'a11y.highIntensityState.detectorPatternLabelStringProperty' );
addToMapIfDefined( 'a11y_highIntensityState_waveProgressLabel', 'a11y.highIntensityState.waveProgressLabelStringProperty' );
addToMapIfDefined( 'a11y_highIntensityState_displayToolsLabel', 'a11y.highIntensityState.displayToolsLabelStringProperty' );
addToMapIfDefined( 'a11y_highIntensityState_noticeLabel', 'a11y.highIntensityState.noticeLabelStringProperty' );
...
addToMapIfDefined( 'a11y_highIntensityState_notice', 'a11y.highIntensityState.noticeStringProperty' );
...
addToMapIfDefined( 'a11y_highIntensityResponses_snapshotTaken', 'a11y.highIntensityResponses.snapshotTakenStringProperty' );
addToMapIfDefined( 'a11y_highIntensityResponses_screenCleared', 'a11y.highIntensityResponses.screenClearedStringProperty' );
addToMapIfDefined( 'a11y_highIntensityResponses_timeChanged', 'a11y.highIntensityResponses.timeChangedStringProperty' );
...
addToMapIfDefined( 'a11y_highIntensityResponses_patternFormationStarted', 'a11y.highIntensityResponses.patternFormationStartedStringProperty' );
addToMapIfDefined( 'a11y_highIntensityResponses_patternFormationComplete', 'a11y.highIntensityResponses.patternFormationCompleteStringProperty' );
...
addToMapIfDefined( 'a11y_experimentSetupDetails_slitConfigurationTopBottom', 'a11y.experimentSetupDetails.slitConfigurationTopBottomStringProperty' );
...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    highIntensityState: {
      headingStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_highIntensityState_heading', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.headingStringProperty' ) ),
      sourceLabelStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_highIntensityState_sourceLabel', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.sourceLabelStringProperty' ) ),
      slitsLabelStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_highIntensityState_slitsLabel', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.slitsLabelStringProperty' ) ),
      detectorPatternLabelStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_highIntensityState_detectorPatternLabel', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.detectorPatternLabelStringProperty' ) ),
      waveProgressLabelStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_highIntensityState_waveProgressLabel', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.waveProgressLabelStringProperty' ) ),
      displayToolsLabelStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_highIntensityState_displayToolsLabel', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.displayToolsLabelStringProperty' ) ),
      noticeLabelStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_highIntensityState_noticeLabel', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.noticeLabelStringProperty' ) ),
      ...
      detectorPattern: new FluentPattern<{ bandCount: FluentVariable, centralWidth: FluentVariable, detectionMode: 'averageIntensity' | 'hits' | TReadOnlyProperty<'averageIntensity' | 'hits'>, hitCount: FluentVariable, hitStage: FluentVariable, patternKind: 'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier' | TReadOnlyProperty<'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier'>, spacing: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_highIntensityState_detectorPattern', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.detectorPatternStringProperty' ), [{"name":"bandCount"},{"name":"centralWidth"},{"name":"detectionMode","variants":["averageIntensity","hits"]},{"name":"hitCount"},{"name":"hitStage"},{"name":"patternKind","variants":["doubleSlitInterference","singleSlitDiffraction","whichPathDiffraction","noBarrier"]},{"name":"spacing"}] ),
      waveProgress: new FluentPattern<{ progress: FluentVariable, waveProgressCheckpoint: 'quarter' | 'half' | 'threeQuarters' | 'full' | 'none' | TReadOnlyProperty<'quarter' | 'half' | 'threeQuarters' | 'full' | 'none'>, waveProgressStage: 'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen' | TReadOnlyProperty<'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityState_waveProgress', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.waveProgressStringProperty' ), [{"name":"progress"},{"name":"waveProgressCheckpoint","variants":["quarter","half","threeQuarters","full","none"]},{"name":"waveProgressStage","variants":["sourceOff","travelingToSlits","atSlits","interferingAfterSlits","diffractingAfterSlits","whichPathAfterSlits","directToScreen","hittingScreen"]}] ),
      displayTools: new FluentPattern<{ brightness: FluentVariable, displayMode: 'graph' | 'screen' | TReadOnlyProperty<'graph' | 'screen'>, positionPlot: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, snapshotCount: FluentVariable, stopwatch: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, tapeMeasure: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, timePlot: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, waveDisplayMode: 'electricField' | 'timeAveragedIntensity' | 'realPart' | 'imaginaryPart' | 'magnitude' | TReadOnlyProperty<'electricField' | 'timeAveragedIntensity' | 'realPart' | 'imaginaryPart' | 'magnitude'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityState_displayTools', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.displayToolsStringProperty' ), [{"name":"brightness"},{"name":"displayMode","variants":["graph","screen"]},{"name":"positionPlot","variants":["true","false"]},{"name":"snapshotCount"},{"name":"stopwatch","variants":["true","false"]},{"name":"tapeMeasure","variants":["true","false"]},{"name":"timePlot","variants":["true","false"]},{"name":"waveDisplayMode","variants":["electricField","timeAveragedIntensity","realPart","imaginaryPart","magnitude"]}] ),
      notice: new FluentPattern<{ patternKind: 'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier' | TReadOnlyProperty<'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityState_notice', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityState.noticeStringProperty' ), [{"name":"patternKind","variants":["doubleSlitInterference","singleSlitDiffraction","whichPathDiffraction","noBarrier"]}] )
    },
    highIntensityResponses: {
      sourceStarted: new FluentPattern<{ isPlaying: 'false' | 'true' | TReadOnlyProperty<'false' | 'true'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_sourceStarted', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.sourceStartedStringProperty' ), [{"name":"isPlaying","variants":["false","true"]}] ),
      sourceStoppedStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_sourceStopped', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.sourceStoppedStringProperty' ) ),
      particleTypeChanged: new FluentPattern<{ sourceType: 'photons' | 'electrons' | 'neutrons' | 'heliumAtoms' | TReadOnlyProperty<'photons' | 'electrons' | 'neutrons' | 'heliumAtoms'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_particleTypeChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.particleTypeChangedStringProperty' ), [{"name":"sourceType","variants":["photons","electrons","neutrons","heliumAtoms"]}] ),
      ...
      slitConfigurationChanged: new FluentPattern<{ slitSetting: 'bothOpen' | 'leftCovered' | 'rightCovered' | 'leftDetector' | 'rightDetector' | 'noBarrier' | 'bothDetectors' | TReadOnlyProperty<'bothOpen' | 'leftCovered' | 'rightCovered' | 'leftDetector' | 'rightDetector' | 'noBarrier' | 'bothDetectors'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_slitConfigurationChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.slitConfigurationChangedStringProperty' ), [{"name":"slitSetting","variants":["bothOpen","leftCovered","rightCovered","leftDetector","rightDetector","noBarrier","bothDetectors"]}] ),
      slitSeparationChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, spacingTrend: 'closer' | 'farther' | 'unchanged' | TReadOnlyProperty<'closer' | 'farther' | 'unchanged'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_slitSeparationChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.slitSeparationChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]},{"name":"spacingTrend","variants":["closer","farther","unchanged"]}] ),
      wavelengthChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, spacingTrend: 'closer' | 'farther' | 'unchanged' | TReadOnlyProperty<'closer' | 'farther' | 'unchanged'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_wavelengthChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.wavelengthChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]},{"name":"spacingTrend","variants":["closer","farther","unchanged"]}] ),
      speedChanged: new FluentPattern<{ isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, spacingTrend: 'closer' | 'farther' | 'unchanged' | TReadOnlyProperty<'closer' | 'farther' | 'unchanged'>, speedTrend: 'increased' | 'decreased' | 'unchanged' | TReadOnlyProperty<'increased' | 'decreased' | 'unchanged'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_speedChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.speedChangedStringProperty' ), [{"name":"isEmitting","variants":["true","false"]},{"name":"spacingTrend","variants":["closer","farther","unchanged"]},{"name":"speedTrend","variants":["increased","decreased","unchanged"]}] ),
      displayModeChanged: new FluentPattern<{ detectionMode: 'averageIntensity' | 'hits' | TReadOnlyProperty<'averageIntensity' | 'hits'>, displayMode: 'graph' | 'screen' | TReadOnlyProperty<'graph' | 'screen'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_displayModeChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.displayModeChangedStringProperty' ), [{"name":"detectionMode","variants":["averageIntensity","hits"]},{"name":"displayMode","variants":["graph","screen"]}] ),
      ...
      waveDisplayChanged: new FluentPattern<{ waveDisplayMode: 'electricField' | 'timeAveragedIntensity' | 'realPart' | 'imaginaryPart' | 'magnitude' | TReadOnlyProperty<'electricField' | 'timeAveragedIntensity' | 'realPart' | 'imaginaryPart' | 'magnitude'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_waveDisplayChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.waveDisplayChangedStringProperty' ), [{"name":"waveDisplayMode","variants":["electricField","timeAveragedIntensity","realPart","imaginaryPart","magnitude"]}] ),
      ...
      snapshotTaken: new FluentPattern<{ snapshotCount: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_snapshotTaken', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.snapshotTakenStringProperty' ), [{"name":"snapshotCount"}] ),
      screenCleared: new FluentPattern<{ detectionMode: 'averageIntensity' | 'hits' | TReadOnlyProperty<'averageIntensity' | 'hits'>, isEmitting: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_screenCleared', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.screenClearedStringProperty' ), [{"name":"detectionMode","variants":["averageIntensity","hits"]},{"name":"isEmitting","variants":["true","false"]}] ),
      timeChanged: new FluentPattern<{ isPlaying: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, timeSpeed: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_timeChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.timeChangedStringProperty' ), [{"name":"isPlaying","variants":["true","false"]},{"name":"timeSpeed"}] ),
      hitStageChanged: new FluentPattern<{ hitStage: 'none' | number | 'few' | 'emerging' | 'developing' | 'clear' | TReadOnlyProperty<'none' | number | 'few' | 'emerging' | 'developing' | 'clear'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_hitStageChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.hitStageChangedStringProperty' ), [{"name":"hitStage","variants":["none",{"type":"number","value":"few"},"emerging","developing","clear"]}] ),
      waveProgressChanged: new FluentPattern<{ progress: FluentVariable, waveProgressCheckpoint: 'quarter' | 'half' | 'threeQuarters' | 'full' | 'none' | TReadOnlyProperty<'quarter' | 'half' | 'threeQuarters' | 'full' | 'none'>, waveProgressStage: 'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen' | TReadOnlyProperty<'sourceOff' | 'travelingToSlits' | 'atSlits' | 'interferingAfterSlits' | 'diffractingAfterSlits' | 'whichPathAfterSlits' | 'directToScreen' | 'hittingScreen'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_waveProgressChanged', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.waveProgressChangedStringProperty' ), [{"name":"progress"},{"name":"waveProgressCheckpoint","variants":["quarter","half","threeQuarters","full","none"]},{"name":"waveProgressStage","variants":["sourceOff","travelingToSlits","atSlits","interferingAfterSlits","diffractingAfterSlits","whichPathAfterSlits","directToScreen","hittingScreen"]}] ),
      patternFormationStarted: new FluentPattern<{ detectionMode: 'averageIntensity' | 'hits' | TReadOnlyProperty<'averageIntensity' | 'hits'>, patternKind: 'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier' | TReadOnlyProperty<'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_patternFormationStarted', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.patternFormationStartedStringProperty' ), [{"name":"detectionMode","variants":["averageIntensity","hits"]},{"name":"patternKind","variants":["doubleSlitInterference","singleSlitDiffraction","whichPathDiffraction","noBarrier"]}] ),
      patternFormationComplete: new FluentPattern<{ bandCount: FluentVariable, patternKind: 'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier' | TReadOnlyProperty<'doubleSlitInterference' | 'singleSlitDiffraction' | 'whichPathDiffraction' | 'noBarrier'> }>( fluentSupport.bundleProperty, 'a11y_highIntensityResponses_patternFormationComplete', _.get( QuantumWaveInterferenceStrings, 'a11y.highIntensityResponses.patternFormationCompleteStringProperty' ), [{"name":"bandCount"},{"name":"patternKind","variants":["doubleSlitInterference","singleSlitDiffraction","whichPathDiffraction","noBarrier"]}] ),
    ...
    experimentSetupDetails: {
      ...
      slitConfigurationTopBottom: new FluentPattern<{ slitSetting: 'bothOpen' | 'leftCovered' | 'rightCovered' | 'leftDetector' | 'rightDetector' | 'noBarrier' | 'bothDetectors' | TReadOnlyProperty<'bothOpen' | 'leftCovered' | 'rightCovered' | 'leftDetector' | 'rightDetector' | 'noBarrier' | 'bothDetectors'> }>( fluentSupport.bundleProperty, 'a11y_experimentSetupDetails_slitConfigurationTopBottom', _.get( QuantumWaveInterferenceStrings, 'a11y.experimentSetupDetails.slitConfigurationTopBottomStringProperty' ), [{"name":"slitSetting","variants":["bothOpen","leftCovered","rightCovered","leftDetector","rightDetector","noBarrier","bothDetectors"]}] ),
