...
const QuantumWaveInterferenceFluent = {
  ...
  a11y: {
    ...
    detectorScreen: {
      ...
      _comment_0: new FluentComment( {"comment":"Shared running-total clause appended to snapshot hits paragraphs via snapshotHitsParagraph, e.g. \"Detector screen","associatedKey":"snapshotHitTotal"} ),
      _comment_1: new FluentComment( {"comment":"shows a total of 3 hits.\" Defined once so the count wording stays consistent across all snapshot stages.","associatedKey":"snapshotHitTotal"} ),
      ...
      _comment_2: new FluentComment( {"comment":"Composes a snapshot hits paragraph: the same description used for the live detector screen, followed by the","associatedKey":"snapshotHitsParagraph"} ),
      _comment_3: new FluentComment( {"comment":"running total of hits captured in the snapshot.","associatedKey":"snapshotHitsParagraph"} ),
      snapshotHitsParagraph: new FluentPattern<{ description: FluentVariable, hitCount: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_snapshotHitsParagraph', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.snapshotHitsParagraphStringProperty' ), [{"name":"description"},{"name":"hitCount","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
      accessibleParagraph: {
