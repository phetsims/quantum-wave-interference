...
addToMapIfDefined( 'a11y_detectorScreen_accessibleParagraph_snapshotHitsSteadyStatePattern', 'a11y.detectorScreen.accessibleParagraph.snapshotHitsSteadyStatePatternStringProperty' );
...
addToMapIfDefined( 'a11y_detectorScreen_accessibleParagraph_snapshotHitsNoBarrierEmerging', 'a11y.detectorScreen.accessibleParagraph.snapshotHitsNoBarrierEmergingStringProperty' );
addToMapIfDefined( 'a11y_detectorScreen_accessibleParagraph_snapshotHitsNoBarrierDeveloping', 'a11y.detectorScreen.accessibleParagraph.snapshotHitsNoBarrierDevelopingStringProperty' );
addToMapIfDefined( 'a11y_detectorScreen_accessibleParagraph_snapshotHitsNoBarrierSteadyStatePattern', 'a11y.detectorScreen.accessibleParagraph.snapshotHitsNoBarrierSteadyStatePatternStringProperty' );
  ...
  a11y: {
    ...
    detectorScreen: {
      ...
      accessibleParagraph: {
        ...
        snapshotHitsSteadyStatePattern: new FluentPattern<{ envelope: 'clusteringIntoTwoFaintSections' | 'clusteringIntoTwoDistinctSections' | 'brightestAtCenter' | TReadOnlyProperty<'clusteringIntoTwoFaintSections' | 'clusteringIntoTwoDistinctSections' | 'brightestAtCenter'>, hitCount: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'>, spatialDescription: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_snapshotHitsSteadyStatePattern', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.snapshotHitsSteadyStatePatternStringProperty' ), [{"name":"envelope","variants":["clusteringIntoTwoFaintSections","clusteringIntoTwoDistinctSections","brightestAtCenter"]},{"name":"hitCount","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]},{"name":"spatialDescription"}] ),
        ...
        snapshotHitsNoBarrierEmerging: new FluentPattern<{ hitCount: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_snapshotHitsNoBarrierEmerging', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.snapshotHitsNoBarrierEmergingStringProperty' ), [{"name":"hitCount","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
        snapshotHitsNoBarrierDeveloping: new FluentPattern<{ hitCount: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_snapshotHitsNoBarrierDeveloping', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.snapshotHitsNoBarrierDevelopingStringProperty' ), [{"name":"hitCount","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
        snapshotHitsNoBarrierSteadyStatePattern: new FluentPattern<{ hitCount: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_detectorScreen_accessibleParagraph_snapshotHitsNoBarrierSteadyStatePattern', _.get( QuantumWaveInterferenceStrings, 'a11y.detectorScreen.accessibleParagraph.snapshotHitsNoBarrierSteadyStatePatternStringProperty' ), [{"name":"hitCount","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] )
      },
      spatialDescription: {
