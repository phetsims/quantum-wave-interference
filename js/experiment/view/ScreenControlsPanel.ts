...
/**
 * ScreenControlsPanel contains the detection mode radio buttons ('Intensity' vs 'Hits') and a 'Screen brightness'
...
type ScreenControlsPanelOptions = SelfOptions & PickRequired<PanelOptions, 'tandem'>;

export default class ScreenControlsPanel extends Panel {
  ...
  public constructor( detectionModeProperty: PhetioProperty<DetectionMode>,
                      ...
                      providedOptions: ScreenControlsPanelOptions ) {

    const options = optionize<ScreenControlsPanelOptions, SelfOptions, PanelOptions>()( {
      isDisposable: false,
      xMargin: 0,
      yMargin: 6,
      fill: null,
