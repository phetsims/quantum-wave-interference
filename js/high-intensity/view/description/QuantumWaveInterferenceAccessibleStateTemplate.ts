...
export default class QuantumWaveInterferenceAccessibleStateTemplate {
  ...
  public static createDependencies( model: HighIntensityModel ): TReadOnlyProperty<unknown>[] {
    return Array.from( new Set( [
      ...
      ...QuantumWaveInterferenceFluent.a11y.waveExperimentState.overview.getDependentProperties(),
      ...QuantumWaveInterferenceFluent.a11y.waveExperimentState.sourceStatus.getDependentProperties(),
      ...
      ...QuantumWaveInterferenceFluent.a11y.waveExperimentState.waveProgress.getDependentProperties(),
      ...QuantumWaveInterferenceFluent.a11y.waveExperimentState.displayTools.getDependentProperties(),
