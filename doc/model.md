...
| Wave display | Photons can show amplitude or electric field. Matter particles can show amplitude or real part. Amplitude is the complex magnitude sqrt( re^2 + im^2 ) for all source types. |
